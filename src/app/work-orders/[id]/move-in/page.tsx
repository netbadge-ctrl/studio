...
export default function MoveInPage({ params }: { params: { id: string } }) {
  const [title, setTitle] = useState(`迁入操作 #${params.id}`);
      ...
      <main className="flex-1 bg-muted/40 p-4 md:p-6 pb-24">
        <div className="max-w-7xl mx-auto">
          <DatacenterOpsDemo 
            ...
            initialView={{ name: 'MOVE_IN', workOrderId: params.id } as any}
