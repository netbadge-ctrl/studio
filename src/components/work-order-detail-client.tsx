...
import { Lightbulb, LightbulbOff, QrCode, MapPin, Layers, Server as ServerIcon, HardDrive, MemoryStick, Cpu, ArrowRight, Network, ChevronDown } from 'lucide-react';
        ...
        <CardHeader>
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
              <div>
                  ...
                  <CardDescription>工单 #{workOrder.id} - 共 {workOrder.devices.length} 台设备</CardDescription>
              </div>
